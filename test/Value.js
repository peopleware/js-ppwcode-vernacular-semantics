...
define(["ppwcode-util-contracts/doh",
  ...
  function(doh,
    ...
    function testGeneratorValue(Constructor, kwargs1, kwargs2, json2objectPropertyNames) {
      // json2objectPropertyNames: Object
      ...
      doh.register(Constructor.mid, [
        ...
        function testConstructor() {
          ...
          for (var pName in kwargs1) {
            ...
            doh.is(kwargs1[pName], subjectValue(subject, pName, json2objectPropertyNames));
          }
        },
