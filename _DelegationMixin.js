...
define(["dojo/_base/declare", "dojo/Stateful", "ppwcode-util-contracts/_Mixin",
        "ppwcode-util-oddsAndEnds/bindingChains", "module"],
    ...
    var _DelegationMixing = declare([Stateful, _ContractMixin], {
      ...
      postscript: function() {
        ...
        for (var delegatedPropertyName in self["-delegated-"]) {
          ...
          self["-delegated-"][delegatedPropertyName].fullNameChain =
          self["-delegated-"][delegatedPropertyName].path.split(".");
          //noinspection JSUnfilteredForInLoop
          self["-delegated-"][delegatedPropertyName].lastContextNameChain =
          self["-delegated-"][delegatedPropertyName].fullNameChain.slice(0);
          //noinspection JSUnfilteredForInLoop
          self["-delegated-"][delegatedPropertyName].lastName =
          self["-delegated-"][delegatedPropertyName].lastContextNameChain.pop();
          //noinspection JSUnfilteredForInLoop
