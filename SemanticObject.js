        ...
        if (propertyName || propertyName === "") {
          ...
          if (js.typeOf(validator) === "function") {
            ...
            validatorResult.forEach(function(wildExceptionDefinition) {
              if (js.typeOf(wildExceptionDefinition) === "string") {
              ...
              else if (wildExceptionDefinition.isInstanceOf &&
                       wildExceptionDefinition.isInstanceOf(SemanticException)) {
                ...
                throw "ERROR: could not interpret validator result " +
                      wildExceptionDefinition +
                      " (" +
                      validatorName +
                      " on " +
                      self.toString() +
